...
import tokenizersJson from './data/_es_analyzer_tokenizer.json?raw';
import tokenFiltersJson from './data/_es_analyzer_token_filter.json?raw';
import charFiltersJson from './data/_es_analyzer_char_filter.json?raw';
import compatibilityJson from './data/_es_token_filter_compatibility.json?raw';
