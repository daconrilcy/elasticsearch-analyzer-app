...
class MappingRule(BaseModel):
    ...
    analyzer_project_id: Optional[uuid.UUID] = Field(
        None, description="ID du projet d'analyseur à appliquer (si es_type est 'text')."
    )
    ...
    def analyzer_only_for_text(cls, v: Optional[uuid.UUID], info: ValidationInfo) -> Optional[uuid.UUID]:
        """Valide qu'un analyseur ne peut être appliqué qu'à un champ 'text'."""
